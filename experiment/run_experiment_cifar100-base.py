...
from vfl_cifar100_training import *
...
def set_args(parser):
    ...
    # config file
    parser.add_argument('--c', type=str, default='configs/noaug/cifar100_bestattack.yml', help='config file')
...
if __name__ == '__main__':
    # 列出所有的防御方法
    eplison_range = [0.1, 0.5, 1.0]
    poison_num_range = [1, 2, 4]

    list_of_args = []

    save_path = './model/CIFAR100/noaug/'
