...
csv_file_name = os.path.join(data_directory, 'criteo.csv')
...
train_data.to_csv(path_or_buf=os.path.join(data_directory, 'train.csv'), index=False)
test_data.to_csv(path_or_buf=os.path.join(data_directory, 'test.csv'), index=False)