...
avazu_file_path = r'../../../data/Avazu/train'
...
with open('../../../data/Avazu/vocab_size_{}.pickle'.format(ratio), 'wb') as handle:
    pickle.dump(vocab_dict, handle)

train_data.to_csv(path_or_buf='../../../data/Avazu/new_train_{}_0.9.csv'.format(ratio), index=False)
test_data.to_csv(path_or_buf='../../../data/Avazu/new_test_{}_0.1.csv'.format(ratio), index=False)